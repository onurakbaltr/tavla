...
`)+`
`+p);const y=S+m+a,M=S+p+o,E=Ah(i,i.VERTEX_SHADER,y),A=Ah(i,i.FRAGMENT_SHADER,M);i.attachShader(_,E),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(L){if(r.debug.checkShaderErrors){const V=i.getProgramInfoLog(_)||"",k=i.getShaderInfoLog(E)||"",$=i.getShaderInfoLog(A)||"",X=V.trim(),N=k.trim(),z=$.trim();let J=!0,ut=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,E,A);else{const ct=Ch(i,E,"vertex"),P=Ch(i,A,"fragment");re("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
