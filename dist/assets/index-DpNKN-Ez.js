...
`)}const Vg={[su]:"Linear",[au]:"Reinhard",[ou]:"Cineon",[Gl]:"ACESFilmic",[cu]:"AgX",[hu]:"Neutral",[lu]:"Custom"};function Gg(r,t){const e=Vg[t];return e===void 0?(qt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ca=new O;function Hg(){ae.getLuminanceCoefficients(ca);const r=ca.x.toFixed(4),t=ca.y.toFixed(4),e=ca.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,Ex=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],bx=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],Fh=new Ae,hs=new O,Mo=new O;function Tx(r,t,e){let n=new rc;const i=new at,s=new at,a=new Ne,o=new Up,l=new Fp,c={},h=e.maxTextureSize,u={[zi]:dn,[dn]:zi,[Fn]:Fn},f=new si({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new at},radius:{value:4}},vertexShader:Sx,fragmentShader:yx}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new Ln;g.setAttribute("position",new ni(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Fe(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fa;let p=this.type;this.render=function(A,C,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;A.type===iu&&(qt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),A.type=fa);const v=r.getRenderTarget(),T=r.getActiveCubeFace(),L=r.getActiveMipmapLevel(),V=r.state;V.setBlending(gi),V.buffers.depth.getReversed()===!0?V.buffers.color.setClear(0,0,0,0):V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const k=p!==this.type;k&&C.traverse(function($){$.material&&(Array.isArray($.material)?$.material.forEach(W=>W.needsUpdate=!0):$.material.needsUpdate=!0)});for(let $=0,W=A.length;$<W;$++){const N=A[$],z=N.shadow;if(z===void 0){qt("WebGLShadowMap:",N,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const J=z.getFrameExtents();if(i.multiply(J),s.copy(z.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/J.x),i.x=s.x*J.x,z.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/J.y),i.y=s.y*J.y,z.mapSize.y=s.y)),z.map===null||k===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===fs){if(N.isPointLight){qt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new ei(i.x,i.y,{format:Xr,type:Mi,minFilter:en,magFilter:en,generateMipmaps:!1}),z.map.texture.name=N.name+".shadowMap",z.map.depthTexture=new As(i.x,i.y,Jn),z.map.depthTexture.name=N.name+".shadowMapDepth",z.map.depthTexture.format=Si,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ke,z.map.depthTexture.magFilter=Ke}else{N.isPointLight?(z.map=new wu(i.x),z.map.depthTexture=new tp(i.x,ii)):(z.map=new ei(i.x,i.y),z.map.depthTexture=new As(i.x,i.y,ii)),z.map.depthTexture.name=N.name+".shadowMap",z.map.depthTexture.format=Si;const ct=r.state.buffers.depth.getReversed();this.type===fa?(z.map.depthTexture.compareFunction=ct?$l:Kl,z.map.depthTexture.minFilter=en,z.map.depthTexture.magFilter=en):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Ke,z.map.depthTexture.magFilter=Ke)}z.camera.updateProjectionMatrix()}const ft=z.map.isWebGLCubeRenderTarget?6:1;for(let ct=0;ct<ft;ct++){if(z.map.isWebGLCubeRenderTarget)r.setRenderTarget(z.map,ct),r.clear();else{ct===0&&(r.setRenderTarget(z.map),r.clear());const P=z.getViewport(ct);a.set(s.x*P.x,s.y*P.y,s.x*P.z,s.y*P.w),V.viewport(a)}if(N.isPointLight){const P=z.camera,ut=z.matrix,Vt=N.distance||P.far;Vt!==P.far&&(P.far=Vt,P.updateProjectionMatrix()),hs.setFromMatrixPosition(N.matrixWorld),P.position.copy(hs),Mo.copy(P.position),Mo.add(Ex[ct]),P.up.copy(bx[ct]),P.lookAt(Mo),P.updateMatrixWorld(),ut.makeTranslation(-hs.x,-hs.y,-hs.z),Fh.multiplyMatrices(P.projectionMatrix,P.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Fh,P.coordinateSystem,P.reversedDepth)}else z.updateMatrices(N);n=z.getFrustum(),M(C,I,z.camera,N,this.type)}z.isPointLightShadow!==!0&&this.type===fs&&S(z,I),z.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(v,T,L)};function S(A,C){const I=t.update(_);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new ei(i.x,i.y,{format:Xr,type:Mi})),f.uniforms.shadow_pass.value=A.map.depthTexture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(C,null,I,f,_,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(C,null,I,d,_,null)}function y(A,C,I,v){let T=null;const L=I.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(L!==void 0)T=L;else if(T=I.isPointLight===!0?l:o,r.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const V=T.uuid,k=C.uuid;let $=c[V];$===void 0&&($={},c[V]=$);let W=$[k];W===void 0&&(W=T.clone(),$[k]=W,C.addEventListener("dispose",E)),T=W}if(T.visible=C.visible,T.wireframe=C.wireframe,v===fs?T.side=C.shadowSide!==null?C.shadowSide:C.side:T.side=C.shadowSide!==null?C.shadowSide:u[C.side],T.alphaMap=C.alphaMap,T.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,T.map=C.map,T.clipShadows=C.clipShadows,T.clippingPlanes=C.clippingPlanes,T.clipIntersection=C.clipIntersection,T.displacementMap=C.displacementMap,T.displacementScale=C.displacementScale,T.displacementBias=C.displacementBias,T.wireframeLinewidth=C.wireframeLinewidth,T.linewidth=C.linewidth,I.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const V=r.properties.get(T);V.light=I}return T}function M(A,C,I,v,T){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&T===fs)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,A.matrixWorld);const k=t.update(A),$=A.material;if(Array.isArray($)){const W=k.groups;for(let N=0,z=W.length;N<z;N++){const J=W[N],ft=$[J.materialIndex];if(ft&&ft.visible){const ct=y(A,ft,v,T);A.onBeforeShadow(r,A,C,I,k,ct,J),r.renderBufferDirect(I,null,k,ct,A,J),A.onAfterShadow(r,A,C,I,k,ct,J)}}}else if($.visible){const W=y(A,$,v,T);A.onBeforeShadow(r,A,C,I,k,W,null),r.renderBufferDirect(I,null,k,W,A,null),A.onAfterShadow(r,A,C,I,k,W,null)}}const V=A.children;for(let k=0,$=V.length;k<$;k++)M(V[k],C,I,v,T)}function E(A){A.target.removeEventListener("dispose",E);for(const I in c){const v=c[I],T=A.target.uuid;T in v&&(v[T].dispose(),delete v[T])}}}const Ax={[Lo]:Io,[No]:Oo,[Uo]:Bo,[Hr]:Fo,[Io]:Lo,[Oo]:No,[Bo]:Uo,[Fo]:Hr};function wx(r,t){function e(){let U=!1;const Et=new Ne;let lt=null;const At=new Ne(0,0,0,0);return{setMask:function(ot){lt!==ot&&!U&&(r.colorMask(ot,ot,ot,ot),lt=ot)},setLocked:function(ot){U=ot},setClear:function(ot,et,pt,D,X){X===!0&&(ot*=D,et*=D,pt*=D),Et.set(ot,et,pt,D),At.equals(Et)===!1&&(r.clearColor(ot,et,pt,D),At.copy(Et))},reset:function(){U=!1,lt=null,At.set(-1,0,0,0)}}}function n(){let U=!1,Et=!1,lt=null,At=null,ot=null;return{setReversed:function(et){if(Et!==et){const pt=t.get("EXT_clip_control");et?pt.clipControlEXT(pt.LOWER_LEFT_EXT,pt.ZERO_TO_ONE_EXT):pt.clipControlEXT(pt.LOWER_LEFT_EXT,pt.NEGATIVE_ONE_TO_ONE_EXT),Et=et;const D=ot;ot=null,this.setClear(D)}},getReversed:function(){return Et},setTest:function(et){et?it(r.DEPTH_TEST):wt(r.DEPTH_TEST)},setMask:function(et){lt!==et&&!U&&(r.depthMask(et),lt=et)},setFunc:function(et){if(Et&&(et=Ax[et]),At!==et){switch(et){case Lo:r.depthFunc(r.NEVER);break;case Io:r.depthFunc(r.ALWAYS);break;case No:r.depthFunc(r.LESS);break;case Hr:r.depthFunc(r.LEQUAL);break;case Uo:r.depthFunc(r.EQUAL);break;case Fo:r.depthFunc(r.GEQUAL);break;case Oo:r.depthFunc(r.GREATER);break;case Bo:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}At=et}},setLocked:function(et){U=et},setClear:function(et){ot!==et&&(Et&&(et=1-et),r.clearDepth(et),ot=et)},reset:function(){U=!1,lt=null,At=null,ot=null,Et=!1}}}function i(){let U=!1,Et=null,lt=null,At=null,ot=null,et=null,pt=null,D=null,X=null;return{setTest:function(q){U||(q?it(r.STENCIL_TEST):wt(r.STENCIL_TEST))},setMask:function(q){Et!==q&&!U&&(r.stencilMask(q),Et=q)},setFunc:function(q,mt,Ft){(lt!==q||At!==mt||ot!==Ft)&&(r.stencilFunc(q,mt,Ft),lt=q,At=mt,ot=Ft)},setOp:function(q,mt,Ft){(et!==q||pt!==mt||D!==Ft)&&(r.stencilOp(q,mt,Ft),et=q,pt=mt,D=Ft)},setLocked:function(q){U=q},setClear:function(q){X!==q&&(r.clearStencil(q),X=q)},reset:function(){U=!1,Et=null,lt=null,At=null,ot=null,et=null,pt=null,D=null,X=null}}}const s=new e,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},f=new WeakMap,d=[],g=null,_=!1,m=null,p=null,S=null,y=null,M=null,E=null,A=null,C=new se(0,0,0),I=0,v=!1,T=null,L=null,V=null,k=null,$=null;const W=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,z=0;const J=r.getParameter(r.VERSION);J.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(J)[1]),N=z>=1):J.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),N=z>=2);let ft=null,ct={};const P=r.getParameter(r.SCISSOR_BOX),ut=r.getParameter(r.VIEWPORT),Vt=new Ne().fromArray(P),$t=new Ne().fromArray(ut);function Qt(U,Et,lt,At){const ot=new Uint8Array(4),et=r.createTexture();r.bindTexture(U,et),r.texParameteri(U,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(U,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let pt=0;pt<lt;pt++)U===r.TEXTURE_3D||U===r.TEXTURE_2D_ARRAY?r.texImage3D(Et,0,r.RGBA,1,1,At,0,r.RGBA,r.UNSIGNED_BYTE,ot):r.texImage2D(Et+pt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ot);return et}const j={};j[r.TEXTURE_2D]=Qt(r.TEXTURE_2D,r.TEXTURE_2D,1),j[r.TEXTURE_CUBE_MAP]=Qt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[r.TEXTURE_2D_ARRAY]=Qt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),j[r.TEXTURE_3D]=Qt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),it(r.DEPTH_TEST),a.setFunc(Hr),Q(!1),vt(Dc),it(r.CULL_FACE),nt(gi);function it(U){h[U]!==!0&&(r.enable(U),h[U]=!0)}function wt(U){h[U]!==!1&&(r.disable(U),h[U]=!1)}function kt(U,Et){return u[U]!==Et?(r.bindFramebuffer(U,Et),u[U]=Et,U===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=Et),U===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=Et),!0):!1}function Rt(U,Et){let lt=d,At=!1;if(U){lt=f.get(Et),lt===void 0&&(lt=[],f.set(Et,lt));const ot=U.textures;if(lt.length!==ot.length||lt[0]!==r.COLOR_ATTACHMENT0){for(let et=0,pt=ot.length;et<pt;et++)lt[et]=r.COLOR_ATTACHMENT0+et;lt.length=ot.length,At=!0}}else lt[0]!==r.BACK&&(lt[0]=r.BACK,At=!0);At&&r.drawBuffers(lt)}function ee(U){return g!==U?(r.useProgram(U),g=U,!0):!1}const le={[nr]:r.FUNC_ADD,[Zf]:r.FUNC_SUBTRACT,[Kf]:r.FUNC_REVERSE_SUBTRACT};le[$f]=r.MIN,le[Jf]=r.MAX;const yt={[jf]:r.ZERO,[Qf]:r.ONE,[td]:r.SRC_COLOR,[Po]:r.SRC_ALPHA,[ad]:r.SRC_ALPHA_SATURATE,[rd]:r.DST_COLOR,[nd]:r.DST_ALPHA,[ed]:r.ONE_MINUS_SRC_COLOR,[Do]:r.ONE_MINUS_SRC_ALPHA,[sd]:r.ONE_MINUS_DST_COLOR,[id]:r.ONE_MINUS_DST_ALPHA,[od]:r.CONSTANT_COLOR,[ld]:r.ONE_MINUS_CONSTANT_COLOR,[cd]:r.CONSTANT_ALPHA,[hd]:r.ONE_MINUS_CONSTANT_ALPHA};function nt(U,Et,lt,At,ot,et,pt,D,X,q){if(U===gi){_===!0&&(wt(r.BLEND),_=!1);return}if(_===!1&&(it(r.BLEND),_=!0),U!==Yf){if(U!==m||q!==v){if((p!==nr||M!==nr)&&(r.blendEquation(r.FUNC_ADD),p=nr,M=nr),q)switch(U){case Br:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Lc:r.blendFunc(r.ONE,r.ONE);break;case Ic:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Nc:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:re("WebGLState: Invalid blending: ",U);break}else switch(U){case Br:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Lc:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Ic:re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Nc:re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:re("WebGLState: Invalid blending: ",U);break}S=null,y=null,E=null,A=null,C.set(0,0,0),I=0,m=U,v=q}return}ot=ot||Et,et=et||lt,pt=pt||At,(Et!==p||ot!==M)&&(r.blendEquationSeparate(le[Et],le[ot]),p=Et,M=ot),(lt!==S||At!==y||et!==E||pt!==A)&&(r.blendFuncSeparate(yt[lt],yt[At],yt[et],yt[pt]),S=lt,y=At,E=et,A=pt),(D.equals(C)===!1||X!==I)&&(r.blendColor(D.r,D.g,D.b,X),C.copy(D),I=X),m=U,v=!1}function rt(U,Et){U.side===Fn?wt(r.CULL_FACE):it(r.CULL_FACE);let lt=U.side===dn;Et&&(lt=!lt),Q(lt),U.blending===Br&&U.transparent===!1?nt(gi):nt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),s.setMask(U.colorWrite);const At=U.stencilWrite;o.setTest(At),At&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Bt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?it(r.SAMPLE_ALPHA_TO_COVERAGE):wt(r.SAMPLE_ALPHA_TO_COVERAGE)}function Q(U){T!==U&&(U?r.frontFace(r.CW):r.frontFace(r.CCW),T=U)}function vt(U){U!==Xf?(it(r.CULL_FACE),U!==L&&(U===Dc?r.cullFace(r.BACK):U===qf?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):wt(r.CULL_FACE),L=U}function R(U){U!==V&&(N&&r.lineWidth(U),V=U)}function Bt(U,Et,lt){U?(it(r.POLYGON_OFFSET_FILL),(k!==Et||$!==lt)&&(r.polygonOffset(Et,lt),k=Et,$=lt)):wt(r.POLYGON_OFFSET_FILL)}function xt(U){U?it(r.SCISSOR_TEST):wt(r.SCISSOR_TEST)}function Ut(U){U===void 0&&(U=r.TEXTURE0+W-1),ft!==U&&(r.activeTexture(U),ft=U)}function ht(U,Et,lt){lt===void 0&&(ft===null?lt=r.TEXTURE0+W-1:lt=ft);let At=ct[lt];At===void 0&&(At={type:void 0,texture:void 0},ct[lt]=At),(At.type!==U||At.texture!==Et)&&(ft!==lt&&(r.activeTexture(lt),ft=lt),r.bindTexture(U,Et||j[U]),At.type=U,At.texture=Et)}function w(){const U=ct[ft];U!==void 0&&U.type!==void 0&&(r.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function x(){try{r.compressedTexImage2D(...arguments)}catch(U){re("WebGLState:",U)}}function F(){try{r.compressedTexImage3D(...arguments)}catch(U){re("WebGLState:",U)}}function K(){try{r.texSubImage2D(...arguments)}catch(U){re("WebGLState:",U)}}function tt(){try{r.texSubImage3D(...arguments)}catch(U){re("WebGLState:",U)}}function H(){try{r.compressedTexSubImage2D(...arguments)}catch(U){re("WebGLState:",U)}}function Ct(){try{r.compressedTexSubImage3D(...arguments)}catch(U){re("WebGLState:",U)}}function dt(){try{r.texStorage2D(...arguments)}catch(U){re("WebGLState:",U)}}function Pt(){try{r.texStorage3D(...arguments)}catch(U){re("WebGLState:",U)}}function zt(){try{r.texImage2D(...arguments)}catch(U){re("WebGLState:",U)}}function st(){try{r.texImage3D(...arguments)}catch(U){re("WebGLState:",U)}}function _t(U){Vt.equals(U)===!1&&(r.scissor(U.x,U.y,U.z,U.w),Vt.copy(U))}function Lt(U){$t.equals(U)===!1&&(r.viewport(U.x,U.y,U.z,U.w),$t.copy(U))}function Nt(U,Et){let lt=c.get(Et);lt===void 0&&(lt=new WeakMap,c.set(Et,lt));let At=lt.get(U);At===void 0&&(At=r.getUniformBlockIndex(Et,U.name),lt.set(U,At))}function gt(U,Et){const At=c.get(Et).get(U);l.get(Et)!==At&&(r.uniformBlockBinding(Et,At,U.__bindingPointIndex),l.set(Et,At))}function Yt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},ft=null,ct={},u={},f=new WeakMap,d=[],g=null,_=!1,m=null,p=null,S=null,y=null,M=null,E=null,A=null,C=new se(0,0,0),I=0,v=!1,T=null,L=null,V=null,k=null,$=null,Vt.set(0,0,r.canvas.width,r.canvas.height),$t.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:it,disable:wt,bindFramebuffer:kt,drawBuffers:Rt,useProgram:ee,setBlending:nt,setMaterial:rt,setFlipSided:Q,setCullFace:vt,setLineWidth:R,setPolygonOffset:Bt,setScissorTest:xt,activeTexture:Ut,bindTexture:ht,unbindTexture:w,compressedTexImage2D:x,compressedTexImage3D:F,texImage2D:zt,texImage3D:st,updateUBOMapping:Nt,uniformBlockBinding:gt,texStorage2D:dt,texStorage3D:Pt,texSubImage2D:K,texSubImage3D:tt,compressedTexSubImage2D:H,compressedTexSubImage3D:Ct,scissor:_t,viewport:Lt,reset:Yt}}function Cx(r,t,e,n,i,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new at,h=new WeakMap;let u;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,x){return d?new OffscreenCanvas(w,x):ba("canvas")}function _(w,x,F){let K=1;const tt=ht(w);if((tt.width>F||tt.height>F)&&(K=F/Math.max(tt.width,tt.height)),K<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const H=Math.floor(K*tt.width),Ct=Math.floor(K*tt.height);u===void 0&&(u=g(H,Ct));const dt=x?g(H,Ct):u;return dt.width=H,dt.height=Ct,dt.getContext("2d").drawImage(w,0,0,H,Ct),qt("WebGLRenderer: Texture has been resized from ("+tt.width+"x"+tt.height+") to ("+H+"x"+Ct+")."),dt}else return"data"in w&&qt("WebGLRenderer: Image in DataTexture is too big ("+tt.width+"x"+tt.height+")."),w;return w}function m(w){return w.generateMipmaps}function p(w){r.generateMipmap(w)}function S(w){return w.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?r.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function y(w,x,F,K,tt=!1){if(w!==null){if(r[w]!==void 0)return r[w];qt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let H=x;if(x===r.RED&&(F===r.FLOAT&&(H=r.R32F),F===r.HALF_FLOAT&&(H=r.R16F),F===r.UNSIGNED_BYTE&&(H=r.R8)),x===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(H=r.R8UI),F===r.UNSIGNED_SHORT&&(H=r.R16UI),F===r.UNSIGNED_INT&&(H=r.R32UI),F===r.BYTE&&(H=r.R8I),F===r.SHORT&&(H=r.R16I),F===r.INT&&(H=r.R32I)),x===r.RG&&(F===r.FLOAT&&(H=r.RG32F),F===r.HALF_FLOAT&&(H=r.RG16F),F===r.UNSIGNED_BYTE&&(H=r.RG8)),x===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(H=r.RG8UI),F===r.UNSIGNED_SHORT&&(H=r.RG16UI),F===r.UNSIGNED_INT&&(H=r.RG32UI),F===r.BYTE&&(H=r.RG8I),F===r.SHORT&&(H=r.RG16I),F===r.INT&&(H=r.RG32I)),x===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&(H=r.RGB8UI),F===r.UNSIGNED_SHORT&&(H=r.RGB16UI),F===r.UNSIGNED_INT&&(H=r.RGB32UI),F===r.BYTE&&(H=r.RGB8I),F===r.SHORT&&(H=r.RGB16I),F===r.INT&&(H=r.RGB32I)),x===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&(H=r.RGBA8UI),F===r.UNSIGNED_SHORT&&(H=r.RGBA16UI),F===r.UNSIGNED_INT&&(H=r.RGBA32UI),F===r.BYTE&&(H=r.RGBA8I),F===r.SHORT&&(H=r.RGBA16I),F===r.INT&&(H=r.RGBA32I)),x===r.RGB&&(F===r.UNSIGNED_INT_5_9_9_9_REV&&(H=r.RGB9_E5),F===r.UNSIGNED_INT_10F_11F_11F_REV&&(H=r.R11F_G11F_B10F)),x===r.RGBA){const Ct=tt?ya:ae.getTransfer(K);F===r.FLOAT&&(H=r.RGBA32F),F===r.HALF_FLOAT&&(H=r.RGBA16F),F===r.UNSIGNED_BYTE&&(H=Ct===ue?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(H=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(H=r.RGB5_A1)}return(H===r.R16F||H===r.R32F||H===r.RG16F||H===r.RG32F||H===r.RGBA16F||H===r.RGBA32F)&&t.get("EXT_color_buffer_float"),H}function M(w,x){let F;return w?x===null||x===ii||x===bs?F=r.DEPTH24_STENCIL8:x===Jn?F=r.DEPTH32F_STENCIL8:x===Es&&(F=r.DEPTH24_STENCIL8,qt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===ii||x===bs?F=r.DEPTH_COMPONENT24:x===Jn?F=r.DEPTH_COMPONENT32F:x===Es&&(F=r.DEPTH_COMPONENT16),F}function E(w,x){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==Ke&&w.minFilter!==en?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function A(w){const x=w.target;x.removeEventListener("dispose",A),I(x),x.isVideoTexture&&h.delete(x)}function C(w){const x=w.target;x.removeEventListener("dispose",C),T(x)}function I(w){const x=n.get(w);if(x.__webglInit===void 0)return;const F=w.source,K=f.get(F);if(K){const tt=K[x.__cacheKey];tt.usedTimes--,tt.usedTimes===0&&v(w),Object.keys(K).length===0&&f.delete(F)}n.remove(w)}function v(w){const x=n.get(w);r.deleteTexture(x.__webglTexture);const F=w.source,K=f.get(F);delete K[x.__cacheKey],a.memory.textures--}function T(w){const x=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(x.__webglFramebuffer[K]))for(let tt=0;tt<x.__webglFramebuffer[K].length;tt++)r.deleteFramebuffer(x.__webglFramebuffer[K][tt]);else r.deleteFramebuffer(x.__webglFramebuffer[K]);x.__webglDepthbuffer&&r.deleteRenderbuffer(x.__webglDepthbuffer[K])}else{if(Array.isArray(x.__webglFramebuffer))for(let K=0;K<x.__webglFramebuffer.length;K++)r.deleteFramebuffer(x.__webglFramebuffer[K]);else r.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&r.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&r.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let K=0;K<x.__webglColorRenderbuffer.length;K++)x.__webglColorRenderbuffer[K]&&r.deleteRenderbuffer(x.__webglColorRenderbuffer[K]);x.__webglDepthRenderbuffer&&r.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const F=w.textures;for(let K=0,tt=F.length;K<tt;K++){const H=n.get(F[K]);H.__webglTexture&&(r.deleteTexture(H.__webglTexture),a.memory.textures--),n.remove(F[K])}n.remove(w)}let L=0;function V(){L=0}function k(){const w=L;return w>=i.maxTextures&&qt("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+i.maxTextures),L+=1,w}function $(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function W(w,x){const F=n.get(w);if(w.isVideoTexture&&xt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&F.__version!==w.version){const K=w.image;if(K===null)qt("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)qt("WebGLRenderer: Texture marked for update but image is incomplete");else{j(F,w,x);return}}else w.isExternalTexture&&(F.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+x)}function N(w,x){const F=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&F.__version!==w.version){j(F,w,x);return}else w.isExternalTexture&&(F.__webglTexture=w.sourceTexture?w.sourceTexture:null);e.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+x)}function z(w,x){const F=n.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&F.__version!==w.version){j(F,w,x);return}e.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+x)}function J(w,x){const F=n.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&F.__version!==w.version){it(F,w,x);return}e.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+x)}const ft={[pi]:r.REPEAT,[_i]:r.CLAMP_TO_EDGE,[Vo]:r.MIRRORED_REPEAT},ct={[Ke]:r.NEAREST,[dd]:r.NEAREST_MIPMAP_NEAREST,[Vs]:r.NEAREST_MIPMAP_LINEAR,[en]:r.LINEAR,[ka]:r.LINEAR_MIPMAP_NEAREST,[rr]:r.LINEAR_MIPMAP_LINEAR},P={[_d]:r.NEVER,[Sd]:r.ALWAYS,[gd]:r.LESS,[Kl]:r.LEQUAL,[xd]:r.EQUAL,[$l]:r.GEQUAL,[vd]:r.GREATER,[Md]:r.NOTEQUAL};function ut(w,x){if(x.type===Jn&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===en||x.magFilter===ka||x.magFilter===Vs||x.magFilter===rr||x.minFilter===en||x.minFilter===ka||x.minFilter===Vs||x.minFilter===rr)&&qt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(w,r.TEXTURE_WRAP_S,ft[x.wrapS]),r.texParameteri(w,r.TEXTURE_WRAP_T,ft[x.wrapT]),(w===r.TEXTURE_3D||w===r.TEXTURE_2D_ARRAY)&&r.texParameteri(w,r.TEXTURE_WRAP_R,ft[x.wrapR]),r.texParameteri(w,r.TEXTURE_MAG_FILTER,ct[x.magFilter]),r.texParameteri(w,r.TEXTURE_MIN_FILTER,ct[x.minFilter]),x.compareFunction&&(r.texParameteri(w,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(w,r.TEXTURE_COMPARE_FUNC,P[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Ke||x.minFilter!==Vs&&x.minFilter!==rr||x.type===Jn&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");r.texParameterf(w,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,i.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Vt(w,x){let F=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",A));const K=x.source;let tt=f.get(K);tt===void 0&&(tt={},f.set(K,tt));const H=$(x);if(H!==w.__cacheKey){tt[H]===void 0&&(tt[H]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),tt[H].usedTimes++;const Ct=tt[w.__cacheKey];Ct!==void 0&&(tt[w.__cacheKey].usedTimes--,Ct.usedTimes===0&&v(x)),w.__cacheKey=H,w.__webglTexture=tt[H].texture}return F}function $t(w,x,F){return Math.floor(Math.floor(w/F)/x)}function Qt(w,x,F,K){const H=w.updateRanges;if(H.length===0)e.texSubImage2D(r.TEXTURE_2D,0,0,0,x.width,x.height,F,K,x.data);else{H.sort((st,_t)=>st.start-_t.start);let Ct=0;for(let st=1;st<H.length;st++){const _t=H[Ct],Lt=H[st],Nt=_t.start+_t.count,gt=$t(Lt.start,x.width,4),Yt=$t(_t.start,x.width,4);Lt.start<=Nt+1&&gt===Yt&&$t(Lt.start+Lt.count-1,x.width,4)===gt?_t.count=Math.max(_t.count,Lt.start+Lt.count-_t.start):(++Ct,H[Ct]=Lt)}H.length=Ct+1;const dt=r.getParameter(r.UNPACK_ROW_LENGTH),Pt=r.getParameter(r.UNPACK_SKIP_PIXELS),zt=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,x.width);for(let st=0,_t=H.length;st<_t;st++){const Lt=H[st],Nt=Math.floor(Lt.start/4),gt=Math.ceil(Lt.count/4),Yt=Nt%x.width,U=Math.floor(Nt/x.width),Et=gt,lt=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Yt),r.pixelStorei(r.UNPACK_SKIP_ROWS,U),e.texSubImage2D(r.TEXTURE_2D,0,Yt,U,Et,lt,F,K,x.data)}w.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,dt),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Pt),r.pixelStorei(r.UNPACK_SKIP_ROWS,zt)}}function j(w,x,F){let K=r.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(K=r.TEXTURE_2D_ARRAY),x.isData3DTexture&&(K=r.TEXTURE_3D);const tt=Vt(w,x),H=x.source;e.bindTexture(K,w.__webglTexture,r.TEXTURE0+F);const Ct=n.get(H);if(H.version!==Ct.__version||tt===!0){e.activeTexture(r.TEXTURE0+F);const dt=ae.getPrimaries(ae.workingColorSpace),Pt=x.colorSpace===Di?null:ae.getPrimaries(x.colorSpace),zt=x.colorSpace===Di||dt===Pt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,x.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,x.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let st=_(x.image,!1,i.maxTextureSize);st=Ut(x,st);const _t=s.convert(x.format,x.colorSpace),Lt=s.convert(x.type);let Nt=y(x.internalFormat,_t,Lt,x.colorSpace,x.isVideoTexture);ut(K,x);let gt;const Yt=x.mipmaps,U=x.isVideoTexture!==!0,Et=Ct.__version===void 0||tt===!0,lt=H.dataReady,At=E(x,st);if(x.isDepthTexture)Nt=M(x.format===sr,x.type),Et&&(U?e.texStorage2D(r.TEXTURE_2D,1,Nt,st.width,st.height):e.texImage2D(r.TEXTURE_2D,0,Nt,st.width,st.height,0,_t,Lt,null));else if(x.isDataTexture)if(Yt.length>0){U&&Et&&e.texStorage2D(r.TEXTURE_2D,At,Nt,Yt[0].width,Yt[0].height);for(let ot=0,et=Yt.length;ot<et;ot++)gt=Yt[ot],U?lt&&e.texSubImage2D(r.TEXTURE_2D,ot,0,0,gt.width,gt.height,_t,Lt,gt.data):e.texImage2D(r.TEXTURE_2D,ot,Nt,gt.width,gt.height,0,_t,Lt,gt.data);x.generateMipmaps=!1}else U?(Et&&e.texStorage2D(r.TEXTURE_2D,At,Nt,st.width,st.height),lt&&Qt(x,st,_t,Lt)):e.texImage2D(r.TEXTURE_2D,0,Nt,st.width,st.height,0,_t,Lt,st.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){U&&Et&&e.texStorage3D(r.TEXTURE_2D_ARRAY,At,Nt,Yt[0].width,Yt[0].height,st.depth);for(let ot=0,et=Yt.length;ot<et;ot++)if(gt=Yt[ot],x.format!==Xn)if(_t!==null)if(U){if(lt)if(x.layerUpdates.size>0){const pt=dh(gt.width,gt.height,x.format,x.type);for(const D of x.layerUpdates){const X=gt.data.subarray(D*pt/gt.data.BYTES_PER_ELEMENT,(D+1)*pt/gt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ot,0,0,D,gt.width,gt.height,1,_t,X)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ot,0,0,0,gt.width,gt.height,st.depth,_t,gt.data)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,ot,Nt,gt.width,gt.height,st.depth,0,gt.data,0,0);else qt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?lt&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,ot,0,0,0,gt.width,gt.height,st.depth,_t,Lt,gt.data):e.texImage3D(r.TEXTURE_2D_ARRAY,ot,Nt,gt.width,gt.height,st.depth,0,_t,Lt,gt.data)}else{U&&Et&&e.texStorage2D(r.TEXTURE_2D,At,Nt,Yt[0].width,Yt[0].height);for(let ot=0,et=Yt.length;ot<et;ot++)gt=Yt[ot],x.format!==Xn?_t!==null?U?lt&&e.compressedTexSubImage2D(r.TEXTURE_2D,ot,0,0,gt.width,gt.height,_t,gt.data):e.compressedTexImage2D(r.TEXTURE_2D,ot,Nt,gt.width,gt.height,0,gt.data):qt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?lt&&e.texSubImage2D(r.TEXTURE_2D,ot,0,0,gt.width,gt.height,_t,Lt,gt.data):e.texImage2D(r.TEXTURE_2D,ot,Nt,gt.width,gt.height,0,_t,Lt,gt.data)}else if(x.isDataArrayTexture)if(U){if(Et&&e.texStorage3D(r.TEXTURE_2D_ARRAY,At,Nt,st.width,st.height,st.depth),lt)if(x.layerUpdates.size>0){const ot=dh(st.width,st.height,x.format,x.type);for(const et of x.layerUpdates){const pt=st.data.subarray(et*ot/st.data.BYTES_PER_ELEMENT,(et+1)*ot/st.data.BYTES_PER_ELEMENT);e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,et,st.width,st.height,1,_t,Lt,pt)}x.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,st.width,st.height,st.depth,_t,Lt,st.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,Nt,st.width,st.height,st.depth,0,_t,Lt,st.data);else if(x.isData3DTexture)U?(Et&&e.texStorage3D(r.TEXTURE_3D,At,Nt,st.width,st.height,st.depth),lt&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,st.width,st.height,st.depth,_t,Lt,st.data)):e.texImage3D(r.TEXTURE_3D,0,Nt,st.width,st.height,st.depth,0,_t,Lt,st.data);else if(x.isFramebufferTexture){if(Et)if(U)e.texStorage2D(r.TEXTURE_2D,At,Nt,st.width,st.height);else{let ot=st.width,et=st.height;for(let pt=0;pt<At;pt++)e.texImage2D(r.TEXTURE_2D,pt,Nt,ot,et,0,_t,Lt,null),ot>>=1,et>>=1}}else if(Yt.length>0){if(U&&Et){const ot=ht(Yt[0]);e.texStorage2D(r.TEXTURE_2D,At,Nt,ot.width,ot.height)}for(let ot=0,et=Yt.length;ot<et;ot++)gt=Yt[ot],U?lt&&e.texSubImage2D(r.TEXTURE_2D,ot,0,0,_t,Lt,gt):e.texImage2D(r.TEXTURE_2D,ot,Nt,_t,Lt,gt);x.generateMipmaps=!1}else if(U){if(Et){const ot=ht(st);e.texStorage2D(r.TEXTURE_2D,At,Nt,ot.width,ot.height)}lt&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,_t,Lt,st)}else e.texImage2D(r.TEXTURE_2D,0,Nt,_t,Lt,st);m(x)&&p(K),Ct.__version=H.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function it(w,x,F){if(x.image.length!==6)return;const K=Vt(w,x),tt=x.source;e.bindTexture(r.TEXTURE_CUBE_MAP,w.__webglTexture,r.TEXTURE0+F);const H=n.get(tt);if(tt.version!==H.__version||K===!0){e.activeTexture(r.TEXTURE0+F);const Ct=ae.getPrimaries(ae.workingColorSpace),dt=x.colorSpace===Di?null:ae.getPrimaries(x.colorSpace),Pt=x.colorSpace===Di||Ct===dt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,x.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,x.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pt);const zt=x.isCompressedTexture||x.image[0].isCompressedTexture,st=x.image[0]&&x.image[0].isDataTexture,_t=[];for(let et=0;et<6;et++)!zt&&!st?_t[et]=_(x.image[et],!0,i.maxCubemapSize):_t[et]=st?x.image[et].image:x.image[et],_t[et]=Ut(x,_t[et]);const Lt=_t[0],Nt=s.convert(x.format,x.colorSpace),gt=s.convert(x.type),Yt=y(x.internalFormat,Nt,gt,x.colorSpace),U=x.isVideoTexture!==!0,Et=H.__version===void 0||K===!0,lt=tt.dataReady;let At=E(x,Lt);ut(r.TEXTURE_CUBE_MAP,x);let ot;if(zt){U&&Et&&e.texStorage2D(r.TEXTURE_CUBE_MAP,At,Yt,Lt.width,Lt.height);for(let et=0;et<6;et++){ot=_t[et].mipmaps;for(let pt=0;pt<ot.length;pt++){const D=ot[pt];x.format!==Xn?Nt!==null?U?lt&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt,0,0,D.width,D.height,Nt,D.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt,Yt,D.width,D.height,0,D.data):qt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt,0,0,D.width,D.height,Nt,gt,D.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt,Yt,D.width,D.height,0,Nt,gt,D.data)}}}else{if(ot=x.mipmaps,U&&Et){ot.length>0&&At++;const et=ht(_t[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,At,Yt,et.width,et.height)}for(let et=0;et<6;et++)if(st){U?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,_t[et].width,_t[et].height,Nt,gt,_t[et].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Yt,_t[et].width,_t[et].height,0,Nt,gt,_t[et].data);for(let pt=0;pt<ot.length;pt++){const X=ot[pt].image[et].image;U?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt+1,0,0,X.width,X.height,Nt,gt,X.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt+1,Yt,X.width,X.height,0,Nt,gt,X.data)}}else{U?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Nt,gt,_t[et]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Yt,Nt,gt,_t[et]);for(let pt=0;pt<ot.length;pt++){const D=ot[pt];U?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt+1,0,0,Nt,gt,D.image[et]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+et,pt+1,Yt,Nt,gt,D.image[et])}}}m(x)&&p(r.TEXTURE_CUBE_MAP),H.__version=tt.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function wt(w,x,F,K,tt,H){const Ct=s.convert(F.format,F.colorSpace),dt=s.convert(F.type),Pt=y(F.internalFormat,Ct,dt,F.colorSpace),zt=n.get(x),st=n.get(F);if(st.__renderTarget=x,!zt.__hasExternalTextures){const _t=Math.max(1,x.width>>H),Lt=Math.max(1,x.height>>H);tt===r.TEXTURE_3D||tt===r.TEXTURE_2D_ARRAY?e.texImage3D(tt,H,Pt,_t,Lt,x.depth,0,Ct,dt,null):e.texImage2D(tt,H,Pt,_t,Lt,0,Ct,dt,null)}e.bindFramebuffer(r.FRAMEBUFFER,w),Bt(x)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,K,tt,st.__webglTexture,0,R(x)):(tt===r.TEXTURE_2D||tt>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&tt<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,K,tt,st.__webglTexture,H),e.bindFramebuffer(r.FRAMEBUFFER,null)}function kt(w,x,F){if(r.bindRenderbuffer(r.RENDERBUFFER,w),x.depthBuffer){const K=x.depthTexture,tt=K&&K.isDepthTexture?K.type:null,H=M(x.stencilBuffer,tt),Ct=x.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;Bt(x)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,R(x),H,x.width,x.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,R(x),H,x.width,x.height):r.renderbufferStorage(r.RENDERBUFFER,H,x.width,x.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ct,r.RENDERBUFFER,w)}else{const K=x.textures;for(let tt=0;tt<K.length;tt++){const H=K[tt],Ct=s.convert(H.format,H.colorSpace),dt=s.convert(H.type),Pt=y(H.internalFormat,Ct,dt,H.colorSpace);Bt(x)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,R(x),Pt,x.width,x.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,R(x),Pt,x.width,x.height):r.renderbufferStorage(r.RENDERBUFFER,Pt,x.width,x.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Rt(w,x,F){const K=x.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(r.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const tt=n.get(x.depthTexture);if(tt.__renderTarget=x,(!tt.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),K){if(tt.__webglInit===void 0&&(tt.__webglInit=!0,x.depthTexture.addEventListener("dispose",A)),tt.__webglTexture===void 0){tt.__webglTexture=r.createTexture(),e.bindTexture(r.TEXTURE_CUBE_MAP,tt.__webglTexture),ut(r.TEXTURE_CUBE_MAP,x.depthTexture);const zt=s.convert(x.depthTexture.format),st=s.convert(x.depthTexture.type);let _t;x.depthTexture.format===Si?_t=r.DEPTH_COMPONENT24:x.depthTexture.format===sr&&(_t=r.DEPTH24_STENCIL8);for(let Lt=0;Lt<6;Lt++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Lt,0,_t,x.width,x.height,0,zt,st,null)}}else W(x.depthTexture,0);const H=tt.__webglTexture,Ct=R(x),dt=K?r.TEXTURE_CUBE_MAP_POSITIVE_X+F:r.TEXTURE_2D,Pt=x.depthTexture.format===sr?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(x.depthTexture.format===Si)Bt(x)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Pt,dt,H,0,Ct):r.framebufferTexture2D(r.FRAMEBUFFER,Pt,dt,H,0);else if(x.depthTexture.format===sr)Bt(x)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Pt,dt,H,0,Ct):r.framebufferTexture2D(r.FRAMEBUFFER,Pt,dt,H,0);else throw new Error("Unknown depthTexture format")}function ee(w){const x=n.get(w),F=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const K=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),K){const tt=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,K.removeEventListener("dispose",tt)};K.addEventListener("dispose",tt),x.__depthDisposeCallback=tt}x.__boundDepthTexture=K}if(w.depthTexture&&!x.__autoAllocateDepthBuffer)if(F)for(let K=0;K<6;K++)Rt(x.__webglFramebuffer[K],w,K);else{const K=w.texture.mipmaps;K&&K.length>0?Rt(x.__webglFramebuffer[0],w,0):Rt(x.__webglFramebuffer,w,0)}else if(F){x.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(e.bindFramebuffer(r.FRAMEBUFFER,x.__webglFramebuffer[K]),x.__webglDepthbuffer[K]===void 0)x.__webglDepthbuffer[K]=r.createRenderbuffer(),kt(x.__webglDepthbuffer[K],w,!1);else{const tt=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,H=x.__webglDepthbuffer[K];r.bindRenderbuffer(r.RENDERBUFFER,H),r.framebufferRenderbuffer(r.FRAMEBUFFER,tt,r.RENDERBUFFER,H)}}else{const K=w.texture.mipmaps;if(K&&K.length>0?e.bindFramebuffer(r.FRAMEBUFFER,x.__webglFramebuffer[0]):e.bindFramebuffer(r.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=r.createRenderbuffer(),kt(x.__webglDepthbuffer,w,!1);else{const tt=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,H=x.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,H),r.framebufferRenderbuffer(r.FRAMEBUFFER,tt,r.RENDERBUFFER,H)}}e.bindFramebuffer(r.FRAMEBUFFER,null)}function le(w,x,F){const K=n.get(w);x!==void 0&&wt(K.__webglFramebuffer,w,w.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&ee(w)}function yt(w){const x=w.texture,F=n.get(w),K=n.get(x);w.addEventListener("dispose",C);const tt=w.textures,H=w.isWebGLCubeRenderTarget===!0,Ct=tt.length>1;if(Ct||(K.__webglTexture===void 0&&(K.__webglTexture=r.createTexture()),K.__version=x.version,a.memory.textures++),H){F.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer[dt]=[];for(let Pt=0;Pt<x.mipmaps.length;Pt++)F.__webglFramebuffer[dt][Pt]=r.createFramebuffer()}else F.__webglFramebuffer[dt]=r.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer=[];for(let dt=0;dt<x.mipmaps.length;dt++)F.__webglFramebuffer[dt]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(Ct)for(let dt=0,Pt=tt.length;dt<Pt;dt++){const zt=n.get(tt[dt]);zt.__webglTexture===void 0&&(zt.__webglTexture=r.createTexture(),a.memory.textures++)}if(w.samples>0&&Bt(w)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let dt=0;dt<tt.length;dt++){const Pt=tt[dt];F.__webglColorRenderbuffer[dt]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[dt]);const zt=s.convert(Pt.format,Pt.colorSpace),st=s.convert(Pt.type),_t=y(Pt.internalFormat,zt,st,Pt.colorSpace,w.isXRRenderTarget===!0),Lt=R(w);r.renderbufferStorageMultisample(r.RENDERBUFFER,Lt,_t,w.width,w.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+dt,r.RENDERBUFFER,F.__webglColorRenderbuffer[dt])}r.bindRenderbuffer(r.RENDERBUFFER,null),w.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),kt(F.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(H){e.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture),ut(r.TEXTURE_CUBE_MAP,x);for(let dt=0;dt<6;dt++)if(x.mipmaps&&x.mipmaps.length>0)for(let Pt=0;Pt<x.mipmaps.length;Pt++)wt(F.__webglFramebuffer[dt][Pt],w,x,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+dt,Pt);else wt(F.__webglFramebuffer[dt],w,x,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(x)&&p(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Ct){for(let dt=0,Pt=tt.length;dt<Pt;dt++){const zt=tt[dt],st=n.get(zt);let _t=r.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(_t=w.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(_t,st.__webglTexture),ut(_t,zt),wt(F.__webglFramebuffer,w,zt,r.COLOR_ATTACHMENT0+dt,_t,0),m(zt)&&p(_t)}e.unbindTexture()}else{let dt=r.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(dt=w.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(dt,K.__webglTexture),ut(dt,x),x.mipmaps&&x.mipmaps.length>0)for(let Pt=0;Pt<x.mipmaps.length;Pt++)wt(F.__webglFramebuffer[Pt],w,x,r.COLOR_ATTACHMENT0,dt,Pt);else wt(F.__webglFramebuffer,w,x,r.COLOR_ATTACHMENT0,dt,0);m(x)&&p(dt),e.unbindTexture()}w.depthBuffer&&ee(w)}function nt(w){const x=w.textures;for(let F=0,K=x.length;F<K;F++){const tt=x[F];if(m(tt)){const H=S(w),Ct=n.get(tt).__webglTexture;e.bindTexture(H,Ct),p(H),e.unbindTexture()}}}const rt=[],Q=[];function vt(w){if(w.samples>0){if(Bt(w)===!1){const x=w.textures,F=w.width,K=w.height;let tt=r.COLOR_BUFFER_BIT;const H=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ct=n.get(w),dt=x.length>1;if(dt)for(let zt=0;zt<x.length;zt++)e.bindFramebuffer(r.FRAMEBUFFER,Ct.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+zt,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,Ct.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+zt,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,Ct.__webglMultisampledFramebuffer);const Pt=w.texture.mipmaps;Pt&&Pt.length>0?e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ct.__webglFramebuffer[0]):e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ct.__webglFramebuffer);for(let zt=0;zt<x.length;zt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(tt|=r.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(tt|=r.STENCIL_BUFFER_BIT)),dt){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Ct.__webglColorRenderbuffer[zt]);const st=n.get(x[zt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,st,0)}r.blitFramebuffer(0,0,F,K,0,0,F,K,tt,r.NEAREST),l===!0&&(rt.length=0,Q.length=0,rt.push(r.COLOR_ATTACHMENT0+zt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(rt.push(H),Q.push(H),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Q)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,rt))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),dt)for(let zt=0;zt<x.length;zt++){e.bindFramebuffer(r.FRAMEBUFFER,Ct.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+zt,r.RENDERBUFFER,Ct.__webglColorRenderbuffer[zt]);const st=n.get(x[zt]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,Ct.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+zt,r.TEXTURE_2D,st,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ct.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const x=w.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[x])}}}function R(w){return Math.min(i.maxSamples,w.samples)}function Bt(w){const x=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function xt(w){const x=a.render.frame;h.get(w)!==x&&(h.set(w,x),w.update())}function Ut(w,x){const F=w.colorSpace,K=w.format,tt=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||F!==qr&&F!==Di&&(ae.getTransfer(F)===ue?(K!==Xn||tt!==Tn)&&qt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):re("WebGLTextures: Unsupported texture color space:",F)),x}function ht(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=V,this.setTexture2D=W,this.setTexture2DArray=N,this.setTexture3D=z,this.setTextureCube=J,this.rebindTextures=le,this.setupRenderTarget=yt,this.updateRenderTargetMipmap=nt,this.updateMultisampleRenderTarget=vt,this.setupDepthRenderbuffer=ee,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=Bt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Rx(r,t){function e(n,i=Di){let s;const a=ae.getTransfer(i);if(n===Tn)return r.UNSIGNED_BYTE;if(n===Wl)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Xl)return r.UNSIGNED_SHORT_5_5_5_1;if(n===pu)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===mu)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===fu)return r.BYTE;if(n===du)return r.SHORT;if(n===Es)return r.UNSIGNED_SHORT;if(n===Hl)return r.INT;if(n===ii)return r.UNSIGNED_INT;if(n===Jn)return r.FLOAT;if(n===Mi)return r.HALF_FLOAT;if(n===_u)return r.ALPHA;if(n===gu)return r.RGB;if(n===Xn)return r.RGBA;if(n===Si)return r.DEPTH_COMPONENT;if(n===sr)return r.DEPTH_STENCIL;if(n===xu)return r.RED;if(n===ql)return r.RED_INTEGER;if(n===Xr)return r.RG;if(n===Yl)return r.RG_INTEGER;if(n===Zl)return r.RGBA_INTEGER;if(n===da||n===pa||n===ma||n===_a)if(a===ue)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===da)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===pa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ma)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===_a)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===da)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===pa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ma)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===_a)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Go||n===Ho||n===Wo||n===Xo)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Go)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ho)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Wo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Xo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===qo||n===Yo||n===Zo||n===Ko||n===$o||n===Jo||n===jo)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===qo||n===Yo)return a===ue?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Zo)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ko)return s.COMPRESSED_R11_EAC;if(n===$o)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Jo)return s.COMPRESSED_RG11_EAC;if(n===jo)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Qo||n===tl||n===el||n===nl||n===il||n===rl||n===sl||n===al||n===ol||n===ll||n===cl||n===hl||n===ul||n===fl)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Qo)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===tl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===el)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===nl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===il)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===rl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===sl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===al)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ol)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ll)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===cl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===hl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ul)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===fl)return a===ue?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===dl||n===pl||n===ml)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===dl)return a===ue?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===pl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ml)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===_l||n===gl||n===xl||n===vl)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===_l)return s.COMPRESSED_RED_RGTC1_EXT;if(n===gl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===xl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===vl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===bs?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}const Px=`
void main() {
